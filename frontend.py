...
class GUI:
    ...
    __stream_options = [StreamOptions.ONLY_VIDEO, StreamOptions.ONLY_AUDIO, StreamOptions.VIDEO_AND_AUDIO]
    ...
    def create_comboboxes(self) -> None:
        self.__res_combobox = Combobox(self.__window, values=self.__resolutions, state='readonly', textvariable=self.__stream_quality)\
        .place(x=self.__x_axis, y=290)
        self.__stream_combobox = Combobox(self.__window, values=self.__stream_options, state='readonly', textvariable=self.__stream_option)\
